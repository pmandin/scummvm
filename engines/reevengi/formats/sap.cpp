...
#include "engines/reevengi/formats/sap.h"

namespace Reevengi {

Audio::RewindableAudioStream *SapSoundFile::makeAudioStream(const Common::Path &filename) const {
